...
class Data:
    """
        ...
        """
    def __init__(self, add_link: bool = False, min_relevance: float = 0.15, min_rating: int = 50, min_tags: int = 5,num_rate: int = 20, parse_date: bool = False):
